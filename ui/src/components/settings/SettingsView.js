              ...
              <Segment basic>
                <Menu pointing secondary>
                  <Menu.Item
                    ...
                    as={Link}
                    to="/settings/tokens"
                    active={location.pathname.indexOf("/settings/tokens") === 0}
                  />
                  <Menu.Item
                    name="Raft"
                    as={Link}
                    to="/settings/raft"
                    active={location.pathname.indexOf("/settings/raft") === 0}
                  />
                  <Menu.Item
                    name="TaskDefaults"
                    as={Link}
                    to="/settings/taskdefaults"
                    active={
                      location.pathname.indexOf("/settings/taskdefaults") === 0
                    }
                  />
                  <Menu.Item
                    name="CAConfig"
                    as={Link}
                    to="/settings/caconfig"
                    active={
                      location.pathname.indexOf("/settings/caconfig") === 0
                    }
                  />
                  <Menu.Item
                    name="Encryption"
                    ...
                    active={
                      location.pathname.indexOf("/settings/encryption") === 0
                    }
                  />
                  <Menu.Item
                    name="Dispatcher"
                    ...
                    active={
                      location.pathname.indexOf("/settings/dispatcher") === 0
                    }
                  />
                </Menu>
                ...
                <Switch>
                  ...
                  <Route
                    ...
                    path="/settings/raft"
                    component={() => (
                      <RaftForm swarm={swarm} onChange={this.onChangeHandler} />
                    )}
                  />
                  <Route
                    exact
                    path="/settings/taskdefaults"
                    component={() => (
                      <TaskDefaultsForm
                        swarm={swarm}
                        onChange={this.onChangeHandler}
