          ...
          <Grid.Row>
            <Grid.Column width={16}>
              <div className="ui breadcrumb">
                ...
                <div className="active section">{image.Id.replace('sha256:', '').substring(0, 12)}</div>
              </div>
            </Grid.Column>
            <Grid.Column className="ui sixteen wide basic segment">
              ...
              <table className="ui very basic celled table">
                <tbody>
                  <tr><td className="four wide column">Id</td><td>{image.Id}</td></tr>
                  <tr><td>Created</td><td>{moment(image.CreatedAt).toString()}</td></tr>
                  <tr><td>Last Updated</td><td>{moment(image.UpdatedAt).toString()}</td></tr>
                </tbody>
              </table>
            </Grid.Column>
            ...
            <Grid.Column className="ui sixteen wide basic segment">
              ...
              <table className="ui very basic celled table">
                <tbody>
                  <tr><td className="four wide column">Architecture</td><td>{image.Architecture}</td></tr>
