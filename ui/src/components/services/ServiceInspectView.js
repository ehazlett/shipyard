    ...
    const columns = [
          ...
          return (
            <span>
              {row.row.Status.ContainerStatus.ContainerID
                ? <Link
                    to={
                      `/services/inspect/${this.props.match.params.id}/container/${row.row.Status.ContainerStatus.ContainerID}`
                    }
                  >
      ...
      },
      {
        ...
        render: row => {
          return (
            <span>
              {this.state.nodes[row.row.NodeID]
                ? this.state.nodes[row.row.NodeID].Description.Hostname
                : null}
            </span>
          );
        },
          ...
          <Grid.Row>
            <Grid.Column width={16}>
              ...
              <FormsyForm onValidSubmit={this.updateService}>
                {modified &&
                  <Button color="green">Save changes to Service</Button>}
                <Grid divided padded>
                  <Grid.Row>
                    <Grid.Column
                      mobile={16}
                    ...
                    >
                      ...
                      <table className="ui very basic celled table">
                        <tbody>
                          ...
                          <tr>
                            <td>Created</td>
                            <td>{moment(service.CreatedAt).toString()}</td>
                          </tr>
                          <tr>
                            <td>Last Updated</td>
                            <td>{moment(service.UpdatedAt).toString()}</td>
                          </tr>
                        </tbody>
                      </table>
                    </Grid.Column>
                ...
                <Menu pointing secondary>
                  <Menu.Item
                    name="Task Template"
                    active={activeSegment === "Task Template"}
                    onClick={() => {
                      this.changeSegment("Task Template");
                    }}
                  />
                  <Menu.Item
                    name="Scheduling"
                    active={activeSegment === "Scheduling"}
                    onClick={() => {
                      this.changeSegment("Scheduling");
                    }}
                  />
                  <Menu.Item
                    name="Labels and Variables"
                    active={activeSegment === "Labels & Variables"}
                    onClick={() => {
                      this.changeSegment("Labels & Variables");
                    }}
                  />
                  <Menu.Item
                    name="Networking"
                    active={activeSegment === "Networking"}
                    onClick={() => {
                      this.changeSegment("Networking");
                    }}
                  />
                  <Menu.Item
                    name="Volumes"
                    active={activeSegment === "Volumes"}
                    onClick={() => {
                      this.changeSegment("Volumes");
                    }}
                  />
                  <Menu.Item
                    name="Secrets"
                    active={activeSegment === "Secrets"}
                    onClick={() => {
                      this.changeSegment("Secrets");
                    }}
                  />
                  <Menu.Item
                    name="Tasks"
                        ...
                        <tr>
                          ...
                          <td>
                            <Input
                              ...
                              size="tiny"
                              value={_.chain(service)
                                .get("Spec.TaskTemplate.ContainerSpec.Args", "")
                                .join(" ")
                                .value()}
                              onChange={this.stringAsArrayChangeHandler}
                              fluid
                        ...
                        <tr>
                          ...
                          <td>
                            <Input
                              ...
                              value={_.get(
                                service,
                                "Spec.TaskTemplate.ContainerSpec.Dir",
                                ""
                              )}
                              onChange={this.onChangeHandler}
                              fluid
                        ...
                        <tr>
                          ...
                          <td>
                            <Input
                              ...
                              value={_.chain(service)
                                .get(
                                  "Spec.TaskTemplate.ContainerSpec.Groups",
                                  ""
                                )
                                .join(" ")
                                .value()}
                        ...
                        <tr>
                          ...
                          <td>
                            <Input
                              ...
                              value={_.get(
                                service,
                                "Spec.TaskTemplate.ContainerSpec.Hostname",
                                ""
                              )}
                              onChange={this.onChangeHandler}
                              fluid
                        ...
                        <tr>
                          ...
                          <td>
                            <Input
                              ...
                              value={_.get(
                                service,
                                "Spec.TaskTemplate.ContainerSpec.StopGracePeriod",
                                ""
                              )}
                              onChange={this.onChangeHandler}
                              fluid
                        ...
                        <tr>
                          ...
                          <td>
                            {service.Spec.TaskTemplate.ContainerSpec.Healthcheck &&
                              ...
                              ? service.Spec.TaskTemplate.ContainerSpec.Healthcheck.Test.join(
                                  " "
                                )
                              : "None"}
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <Select
                              ...
                              value={_.get(
                                service,
                                "Spec.UpdateConfig.FailureAction",
                                ""
                              )}
                              onChange={this.onChangeHandler}
                              fluid
                        ...
                        <tr>
                          ...
                          <td>
                            <Input
                              ...
                              value={_.get(
                                service,
                                "Spec.UpdateConfig.MaxFailureRatio",
                                ""
                              )}
                              onChange={this.onChangeHandler}
                              fluid
                  ...
                  <Segment basic>
                          ...
                          ? service.Endpoint.Ports.map(p => (
                              <tr key={p.TargetPort}>
                                ...
                                <td>
                                  <a
                                    href={
                                      `${window.location.protocol}//${window.location.hostname}:${p.PublishedPort}`
                                    }
                                    target="_blank"
                                  >
                                    {p.PublishedPort}
                    ...
                    <table className="ui very basic celled table">
                      {service.Spec.Networks
                        ? <thead>
                            <tr>
                              <th>Target</th><th>Name</th><th>Aliases</th>
                            </tr>
                          </thead>
                        : null}
                      <tbody>
                        {service.Spec.Networks
                          ? service.Spec.Networks.map(n => (
                              <tr key={n.Target}>
                                ...
                                <td>
                                  {networks[n.Target]
                                    ? networks[n.Target].Name
                                    : null}
                                </td>
                                <td>
                                  {n.Aliases ? n.Aliases.join(" ") : null}
                                </td>
                              </tr>
                            ))
                    ...
                    <table className="ui very basic celled table">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            {service.Spec.TaskTemplate.ContainerSpec.Hosts
                              ? service.Spec.TaskTemplate.ContainerSpec.Hosts.join(
                                  " "
                                )
                              : null}
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            {service.Spec.TaskTemplate.ContainerSpec.DNSConfig &&
                              ...
                              ? service.Spec.TaskTemplate.ContainerSpec.DNSConfig.Nameservers.join(
                                  " "
                                )
                              : "Default"}
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            {service.Spec.TaskTemplate.ContainerSpec.DNSConfig &&
                              ...
                              ? service.Spec.TaskTemplate.ContainerSpec.DNSConfig.Options.join(
                                  " "
                                )
                              : "Default"}
                          </td>
                    ...
                    <table className="ui very basic celled table">
                      <tbody>
                        {service.Spec.TaskTemplate.ContainerSpec.Env
                          ? service.Spec.TaskTemplate.ContainerSpec.Env.map(
                              e => (
                                <tr key={e}>
                                  <td className="four wide column">
                                    {e.split("=")[0]}
                ...
                {activeSegment === "Volumes" &&
                  <Segment basic>
                    ...
                    <table className="ui very basic celled table">
                      ...
                      <tbody>
                        {service.Spec.TaskTemplate.ContainerSpec.Mounts
                          ? service.Spec.TaskTemplate.ContainerSpec.Mounts.map(
                              m => (
                                <tr key={m.Source}>
                ...
                {activeSegment === "Secrets" &&
                  <Segment basic>
                    ...
                    <table className="ui very basic celled table">
                      ...
                      <tbody>
                        {service.Spec.TaskTemplate.ContainerSpec.Secrets
                          ? service.Spec.TaskTemplate.ContainerSpec.Secrets.map(
                              s => (
                                <tr key={s.SecretID}>
                                  <td className="four wide column">
                                    {s.SecretID}
