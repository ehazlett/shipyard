      ...
      <FormsyForm className="ui form" onValidSubmit={this.createService}>
        ...
        <Form.Group widths="equal">
          <Form.Field>
            ...
            <Input
              ...
              value={_.chain(spec)
                .get("TaskTemplate.ContainerSpec.Command", "")
                .join(" ")
                .value()}
          ...
          <Form.Field>
            ...
            <Input
              ...
              value={_.chain(spec)
                .get("TaskTemplate.ContainerSpec.Args", "")
                .join(" ")
                .value()}
              onChange={this.stringAsArrayChangeHandler}
            />
        ...
        <Form.Group widths="equal">
          ...
          <Form.Field>
            ...
            <Input
              ...
              value={_.chain(spec)
                .get("TaskTemplate.ContainerSpec.Groups", "")
                .join(" ")
                .value()}
              onChange={this.stringAsArrayChangeHandler}
            />
        ...
        <Form.Field>
          ...
          <ControlledInputGroup
            ...
            value={_.get(
              spec,
              "TaskTemplate.ContainerSpec.PlacementConstraints",
              []
            )}
            onChange={this.onChangeHandler}
            singleColumn
