...
const (
	PROVIDER1_NAME = "name 1"
	PROVIDER2_NAME = "name 2"
	PROVIDER3_NAME = "name 3"

	PROVIDER1_URL = "url 1"
	PROVIDER2_URL = "url 2"
	PROVIDER3_URL = "url 3"

	PROVIDER1_NAME2 = "name 1 v2"
	PROVIDER1_URL2  = "url 1 v2"
)

var (
	PROVIDER1_JOB_TYPES = types.Array{}
	PROVIDER2_JOB_TYPES = types.Array{}
	PROVIDER3_JOB_TYPES = types.Array{}

	PROVIDER1_CONFIG types.Object = nil
	PROVIDER2_CONFIG types.Object = nil
	PROVIDER3_CONFIG types.Object = nil

	PROVIDER1_JOBS = []*model.ProviderJob{}
	PROVIDER2_JOBS = []*model.ProviderJob{}
	PROVIDER3_JOB1 = &model.ProviderJob{
		Name: "job_3C",
	}
	PROVIDER3_JOBS = []*model.ProviderJob{
		{
			Name: "job_3A",
		},
		{
	...
	PROVIDER1_JOB_TYPES2              = types.Array{}
	PROVIDER1_CONFIG2    types.Object = nil
	PROVIDER1_JOBS2                   = []*model.ProviderJob{}

	PROVIDER1_SAVED_ID string
	PROVIDER2_SAVED_ID string
	PROVIDER3_SAVED_ID string
)
...
func init() {
	...
	if err != nil {
		panic(fmt.Sprintf("Test init() for providers_test.go failed %s", err))
	}
...
func cleanupProviders() error {

	if err := api.manager.DeleteAllProviders(); err != nil {
		return err
	}
...
func TestProvidersGetAuthToken(t *testing.T) {
...
func TestCleanupProviderTests(t *testing.T) {
