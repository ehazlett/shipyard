...
func AddProjectImage(authHeader, url, projectId string, name string, imageId string, tag string, description string, registryId string, location string, skipImageBuild bool) (int, error) {
	var image *model.Image
	newImage := image.NewImage(name, imageId, tag, description, registryId, location, skipImageBuild, projectId)
